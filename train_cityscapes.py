...
exp_name = 'cityscapes_1024'
# exp_name = 'segnet_bs16'
...
def validate(val_loader, net, device, criterion, optimizer, epoch, train_args, restore, visualize, finetuning=False):
	net.eval()
	...
	if mean_iu > train_args['best_record']['mean_iu']:
		...
		if finetuning == False:
			...
			torch.save(net.state_dict(), os.path.join(ft_ckpt_path, exp_name, snapshot_name + '.pth'))
